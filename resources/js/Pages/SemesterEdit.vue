...
const semesters = ref(props.courses);

let form = reactive({
  uuid: props.semesters.uuid,
  center_id: props.semesters.center_id,
  semester_number: props.semesters.semester_number,
  muhazir_id: props.semesters.muhazir_id,
  mawin_muhazir_id: props.semesters.mawin_muhazir_id,
  start_date: props.semesters.start_date,
  end_date: props.semesters.end_date,
  region_id: props.semesters.region_id,
  zone_id: props.semesters.zone_id,
  _method: "put",
});
...
function semesterSelection() {
  axios({
    method: "get",
    url: "/semester/selection/" + form.center_id,
  })
    .then((response) => {
...
function submit() {
  Inertia.post(route("semesters.update", { semesters: props.semesters.uuid }), form, {
    forceFormData: true,
  });
}
</script>
...
<template>
  <Head title="EditSemester" />
  <BreezeAuthenticatedLayout>
    <div class="sm:flex sm:items-center">
      <div class="sm:flex-auto">
        <BanerHeading
          heading="Update Semester"
